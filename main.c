    ...
    switch( event )
    {
		case BTM_ENABLED_EVT:								// Bluetooth Controller and Host Stack Enabled
			if( WICED_BT_SUCCESS == p_event_data->enabled.status )
			{
				...
				printf( "DIRECCION DEL DISPOSITIVO BLUETOOTH LOCAL: ");
			...
			{
				printf( "FALLO EN EL CONTROLADPOR BLUETOOHT Y STACK \n" );
			}
			break;
